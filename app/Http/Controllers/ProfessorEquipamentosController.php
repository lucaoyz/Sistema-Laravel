...
class ProfessorEquipamentosController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('professor.viewsTreino.equipamentos', [
    ...
    public function store(Request $request)
    {
        ...
        if($equipamentoNome){
            return redirect()->route('professor.equipamentos.index')
