              ...
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex flex-column">
                    ...
                    <span class="text-xs">Conta de água</span>
                  </div>
                  <div class="d-flex align-items-center text-sm">
                    R$ 209,80
                    <a href="{{route('admin.financeiro.notafiscal')}}" class="btn btn-link text-dark text-sm mb-0 px-0 ms-4"><i class="material-icons text-lg position-relative me-1">picture_as_pdf</i> PDF</a>
                  </div>
                </li>
              </ul>
            </div>
