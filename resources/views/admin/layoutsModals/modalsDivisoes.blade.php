...
<!-- modal de treino divisão F -->
<!-- Modal de observação exercício F -->
@foreach($treinoDetalhes as $treinoDetalhe)
<div class="modal fade" id="obsTreinoDetalhesDivisaoF{{$treinoDetalhe->id}}{{$treinoGeral->id}}" tabindex="-1" role="dialog" aria-labelledby="obsTreinoDetalhesDivisaoF{{$treinoDetalhe->id}}{{$treinoGeral->id}}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
...
@endif
<div class="modal fade" id="criarTreinoDetalhesDivisaoF" tabindex="-1" role="dialog" aria-labelledby="criarTreinoDetalhesDivisaoF" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 750px">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title font-weight-normal" id="criarTreinoDetalhesDivisaoE">Criar</h5>
            ...
            <form action="{{ route('treinos.storeDetalhesDivisaoF', $treinoGeral->id) }}" method="POST">
                ...
                <h6>Observação: Apenas 3 Membros Musculares diferentes por treino.</h6>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="td_divisao" type="text" {{ 'F' ? 'readonly' : '' }}
                            class="form-control @error('td_divisao') is-invalid @enderror"
                            name="td_divisao" value="F" required autocomplete="td_divisao" autofocus>
...
@endif
<div class="modal fade" id="editarTreinoDetalhesDivisaoF{{$treinoDetalhe->id}}{{$treinoGeral->id}}" tabindex="-1" role="dialog" aria-labelledby="editarTreinoDetalhesDivisaoF{{$treinoDetalhe->id}}{{$treinoGeral->id}}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 750px">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title font-weight-normal" id="editarTreinoDetalhesDivisaoF{{$treinoDetalhe->id}}">Editar</h5>
          <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form action="{{ route('treinos.updateDetalhesDivisaoF', $treinoGeral->id, $treinoDetalhe->id) }}" method="POST">
                @csrf
                @method('PUT')
...
<!-- Modal de excluir treino detalhes F -->
@foreach($treinoDetalhes as $treinoDetalhe)
<div class="modal fade" id="excluirTreinoDetalhesDivisaoF{{$treinoGeral->id}}{{$treinoDetalhe->id}}" tabindex="-1" role="dialog" aria-labelledby="excluirTreinoDetalhesDivisaoF{{$treinoGeral->id}}{{$treinoDetalhe->id}}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title font-weight-normal" id="excluirTreinoDetalhesDivisaoF{{$treinoGeral->id}}{{$treinoDetalhe->id}}">Excluir Exercício</h5>
          <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            ...
            <p>Deseja excluir esse exercício?</p>
            <form action="{{ route('treinos.destroyDetalhesDivisaoF', ['treinoGeral' => $treinoGeral->id, 'treinoDetalhe' => $treinoDetalhe->id]) }}" method="POST">
