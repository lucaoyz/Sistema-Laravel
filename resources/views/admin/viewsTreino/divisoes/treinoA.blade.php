        ...
        <div class="col-12">
          ...
          <div class="card my-4">
            ...
            <div class="pull-right">
                <h5 class="mb-0"><a href="" data-bs-toggle="modal" data-bs-target="#criarTreinoDetalhesDivisaoA" class="btn btn-success">Registre um exercício</a>
                    <a href="{{route('aluno.PDFTreinoDivisoesATreinador', $treinoGeral->id)}}" class="btn btn-primary">Visualize como o aluno baixará o treino</a></h5>
            </div>
            </div>
