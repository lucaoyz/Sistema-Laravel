    ...
    <div class="container-fluid py-4">
      ...
      <div class="row">
        <div class="col-12">
            ...
            <form action="{{route('treinos.searchDetalhesDivisaoB', $treinoGeral->id)}}" method="post">
                @csrf
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Treino B</h6>
              </div>
              <br>
              <!-- Botão de criar -->
            <div class="pull-right">
                <h5 class="mb-0"><a href="" data-bs-toggle="modal" data-bs-target="#criarTreinoDetalhesDivisaoB" class="btn btn-success">Registre um exercício</a>
                    <a href="{{route('aluno.PDFTreinoDivisoesBTreinador', $treinoGeral->id)}}" class="btn btn-primary">Visualize como o aluno baixará o treino</a></h5>
            </div>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                            ...
                            <!-- Editar -->
                            <a class="btn btn-secondary" href="" data-bs-toggle="modal" data-bs-target="#editarTreinoDetalhesDivisaoB{{$treinoDetalhe->id}}{{$treinoGeral->id}}">Editar</a>

                            <!-- Remover -->
                            <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#excluirTreinoDetalhesDivisaoB{{$treinoGeral->id}}{{$treinoDetalhe->id}}">Excluir</a>

                            @if ($treinoDetalhe->exe_descricao == null)
                            @else
                                <!-- Detalhes -->
                                <a class="btn btn-info" href="" data-bs-toggle="modal" data-bs-target="#obsTreinoDetalhesDivisaoB{{$treinoDetalhe->id}}{{$treinoGeral->id}}">Observações</a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
