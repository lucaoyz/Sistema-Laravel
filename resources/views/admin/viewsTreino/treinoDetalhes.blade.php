        ...
        <div class="card-body px-0 pb-2 position-relative mt-n4 mx-3">
            <div class="table-responsive p-0">
                ...
                @if ($treinoGeralDivisoes === 'ABC')
                    ...
                    <!-- Divisão C -->
                    <div class="pull-right">
                        <h5 class="mb-0"><a href="{{route('treinos.createDetalhesDivisaoC', $treinoGeral->id)}}" class="btn btn-success">Treino C</a></h5>
                    </div>
                @endif
                ...
                @if ($treinoGeralDivisoes === 'ABCD')
                    ...
                    <!-- Divisão D -->
                    <div class="pull-right">
                        <h5 class="mb-0"><a href="{{route('treinos.createDetalhesDivisaoD', $treinoGeral->id)}}" class="btn btn-success">Treino D</a></h5>
                    </div>
                @endif
