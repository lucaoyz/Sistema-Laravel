      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">&nbsp;
        <div class="card">
          <div class="card-header p-3 pt-2">
            <div class="pt-1">
              <h6 class="mb-0 text-secondary">Membro muscular: {{$treinoEAluno->exe_membro}}</h6>
              <h5 class="mb-0">Exercício: <span class="text-primary"> {{$treinoEAluno->exe_nome}}</span></h5>
              <h6 class="mb-0">Series: <span class="text-primary"> {{$treinoEAluno->td_series}}</span></h6>
              <h6 class="mb-0">Repetições: <span class="text-primary"> {{$treinoEAluno->td_repeticoes}}</span></h6>
            </div>
          </div>
