...
.tdNumero {
    ...
    <body>
        ...
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Peito</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
        ...
        <p style="margin: 0;">---------------------------</p>
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Costas</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
        ...
        <p style="margin: 0;">---------------------------</p>
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Biceps</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
        ...
        <p style="margin: 0;">---------------------------</p>
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Triceps</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
        ...
        <p style="margin: 0;">---------------------------</p>
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Antebraço</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
        ...
        <p style="margin: 0;">---------------------------</p>
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Ombro</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
        ...
        <p style="margin: 0;">---------------------------</p>
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Trapezio</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
        ...
        <p style="margin: 0;">---------------------------</p>
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Inferior</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
        ...
        <p style="margin: 0;">---------------------------</p>
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Lombar</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
        ...
        <p style="margin: 0;">---------------------------</p>
        <div class="imprimirTreino">
            <p style="font-size: 30px;">Treino C - <span>Abdomen</span></p>
            <table>
                <tr>
                    <th>Nº</th>
                    <th>Exercício</th>
