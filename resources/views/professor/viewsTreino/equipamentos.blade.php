    ...
    <div class="container-fluid py-4">
      ...
      <div class="row">
        <div class="col-12">
            ...
            <form action="{{route('professor.equipamentos.search')}}" method="post">
                @csrf
                <div class="input-group input-group-outline my-3">
                    ...
                    <a class="btn btn-outline-secondary" href="{{route('professor.equipamentos.index')}}">Limpar filtro</a>
                  </div>
            </form>
            </div>
          <div class="card my-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                            <!-- Editar -->
                            <a class="btn btn-secondary" href="{{ route('equipamentos.edit',$equipamento->id) }}" data-bs-toggle="modal" data-bs-target="#editarEquipamentoModal{{$equipamento->id}}">Editar</a>
